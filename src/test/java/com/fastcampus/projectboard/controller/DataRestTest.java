...
public class DataRestTest {
    ...
    @Test
    void given_whenRequest_then() throws Exception {
    ...
    @Test
    void given_whenReply_then() throws Exception {
    ...
    @Test
    void given_whenReplyList_then() throws Exception {
    ...
    @Test
    void given_whenReplyOne_then() throws Exception {
